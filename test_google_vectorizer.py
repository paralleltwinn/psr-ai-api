#!/usr/bin/env python3
"""
Test Google vectorizer specifically with our API key.
"""
...
async def test_google_vectorizer():
    """Test Google vectorizer with our API key."""
    print("=" * 60)
    print("GOOGLE VECTORIZER TEST")
    print("=" * 60)
    ...
    try:
        ...
        client = weaviate.connect_to_weaviate_cloud(
            ...
            headers={
                "X-Google-Api-Key": settings.google_api_key
            }
        )
        ...
        # 3. Create collection with Google vectorizer
        print("\n3. Creating collection with Google vectorizer...")
        ...
        test_data = {
            ...
            "content": "This is a test content about LED troubleshooting and power supply issues. The 12V output is normal but the 24V output is low or zero, indicating a potential power supply fault.",
            "chunk_index": 0,
        ...
        try:
            search_results = collection.query.near_text(
                query="power supply problem 24V",
                limit=1
            )
        ...
        print("\n🎉 GOOGLE VECTORIZER TEST COMPLETED SUCCESSFULLY!")
...
if __name__ == "__main__":
    asyncio.run(test_google_vectorizer())
